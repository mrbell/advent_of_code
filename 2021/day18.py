...
def run_test_cases(test_cases):
    for test_case in test_cases:
        a,b,c = test_case.split('\n')
        a = SnailNumPair(a.strip())
        b = SnailNumPair(b.strip().replace('+ ', ''))
        c = c.replace('= ', '')
        c_eval = a + b
        c_eval.reduce()
        assert str(c_eval) == c
...
if __name__ == '__main__':
    ...
    a = SnailNumPair('[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]')
    assert a.mag() == 3488


    a = SnailNumPair('[[[0,[4,5]],[0,0]],[[[4,5],[2,6]],[9,5]]]')
    b = SnailNumPair('[7,[[[3,7],[4,3]],[[6,3],[8,8]]]]')
    c = a + b
    c.reduce()
    assert str(c) == '[[[[4,0],[5,4]],[[7,7],[6,0]]],[[8,[7,7]],[[7,9],[5,0]]]]'

    test_cases = '''  [[[[4,0],[5,4]],[[7,7],[6,0]]],[[8,[7,7]],[[7,9],[5,0]]]]
...
= [[[[7,7],[7,7]],[[8,7],[8,7]]],[[[7,0],[7,7]],9]]
  ...
  [[[[7,7],[7,7]],[[8,7],[8,7]]],[[[7,0],[7,7]],9]]
+ [[[[4,2],2],6],[8,7]]
= [[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]'''.split('\n\n')
...
[5,5]
[6,6]'''.split('\n')
    example_sum = sum_snail_numbers(test_case)
    assert str(example_sum) == '[[[[5,0],[7,4]],[5,5]],[6,6]]'
...
[[[5,[7,4]],7],1]
[[[[4,2],2],6],[8,7]]'''.split('\n')
    example_sum = sum_snail_numbers(larger_example)
    assert str(example_sum) == '[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]'
